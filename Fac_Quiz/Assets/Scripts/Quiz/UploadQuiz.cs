...
public class UploadQuiz : MonoBehaviour
{
    ...
    public void StartQuiz()
    {
        ...
        String lecturename = GameSceneUserDataManager.Instance().GetLectureName();
       ...
       StartCoroutine(PostRequest(serverURL, quizQues, lecturename,userid));   
    ...
    IEnumerator PostRequest(string url, string quizQues,string lecturename, int userId)
    {
        // 요청 데이터 생성
        ...
        form.AddField("lectureName",lecturename);
